## 1. Модификация алгоритма Дейкстры для «произведения» весов
...
## 2. Алгоритм восстановления графа по матрице кратчайших путей
...
## 3. Ошибка в реализации алгоритма Флойда–Уоршелла
...
## 4. Наличие общего ребра в кратчайших путях в обоих направлениях
